        ...
        <div class="col-span-3 border rounded mx-1 p-2">
            <div v-if="formKey != -1" :key="formKey">
                <div class="px-2 mt-1">
                    ...
                    <hr class="my-1">
                    <formacaostats :formacao="formacoes[formKey]"/>
                    <hr class="my-1">
                                    ...
                                    <div v-for="(sala, index) in encontro.areas[key].salas" :key="index">
                                        <div class="grid grid-cols-12 border rounded p-1 my-1.5 hover:bg-gray-200">
                                            ...
                                            <div class="col-span-4">
                                                <salastats :inscritos="sala.inscricoes"
                                                    :formacaoID="formacoes[formKey].id" :encontroID="encontro.id"
                                                    :salaID="sala.id" :area="key"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div v-if="!formacoes[formKey].turmasPorArea">
                                <div v-for="(sala, index) in encontro.salas" :key="index">
                                    <div class="grid grid-cols-12 border rounded p-1 my-1.5 hover:bg-gray-200">
                                        ...
                                        <div class="col-span-4">
                                            <salastats :inscritos="sala.inscricoes" :formacaoID="formacoes[formKey].id"
                                                :encontroID="encontro.id" :salaID="sala.id" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
import salastats from "./sala-stats.vue"
import { allUserStore } from "@/stores/allUser-store"
import badgearea from "./badge-area.vue"
import formacaostats from "./formacao-stats.vue"

export default {
    components: { badgearea, facilitadorAvatar, salastats, formacaostats },
    data() {
        return {
            formacoes: {},
            tab: "",
