        ...
        <div v-if="!loading" class="py-1">
            <div class="flex items-center justify-between">
                <div class="text-xs font-medium">
                    Médias das respostas por trilha
                </div>
                <div class="text-xs">
                ...
                <div v-for="(pergunta, index) in perguntas" :key="index" class="px-1">
                    <div v-if="perguntas[index].media > 0" class="my-2">
                        <div class="border rounded shadow py-2 px-2">
                            ...
                            <div class="px-2">
                                <q-slider v-model="perguntas[index].media" :label-value="perguntas[index].media/10" :marker-labels="markers" dense
                                    track-size="2px" readonly :max="50" label label-always color="teal" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                if (data) {
                    ...
                    for (let i in self.pesquisas) {
                        ...
                        if (formacaoID == self.formacao.id) {
                            if (encontroID == self.encontro.id) {
