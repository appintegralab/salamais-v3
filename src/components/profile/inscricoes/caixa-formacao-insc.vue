                ...
                <div class="flex items-center text-green-700">
                    ...
                    <div class="flex items-center ml-1 pt-[2px] fw-600 text-[8pt]">
                        ...
                        <q-btn @click="$router.push({ path: '/formacao/' + formacao.id })" outline size="5pt"
                            ...
                            <span class="iconify text-[8pt] mr-1" data-icon="ic:school"></span>
                            ver formação
                        </q-btn>
                        <q-btn v-if="isMe" outline size="5pt" class="px-2 text-[7pt] ml-4 text-red-800">
...
export default {
    ...
    computed: {
        ...
        isMe() {
            return this.userStore.user.id == this.userID
        }
    },
    watch: {
        formacao() {
